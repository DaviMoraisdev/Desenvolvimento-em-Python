...
-> Escreva um programa em python que gera um número aleatório para que 
o usuário tente acertar o número. Algumas sugestões para o programa:
...
2 - Utilizar o módulo random para gerar valores aleatorios
dentro de um intervalo. Ex: 1 a 10

3 - Lê o número que o usuário digitar via input e comparar se
é o mesmo número que o programa sorteou 
"""
import random 
