"""
* Agenda de Contatos 
Desenvolva um agenda de contatos utilizando Programação Orientada a Objetos
...
as duas classes criadas anteriormente e desenvolver e chamar cada um 
dos métodos desenvolvidos de acordo com a opção escolhida 
